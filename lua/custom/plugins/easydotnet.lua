return {
  ...
  config = function()
    ...
    dotnet.setup {
      ...
      get_sdk_path = '/usr/local/share/dotnet/sdk/9.0.202/',
      ...
      test_runner = {
        ...
        mappings = {
          ...
          filter_failed_tests = { lhs = '<leader>Rfe', desc = 'filter failed tests' },
          debug_test = { lhs = '<leader>Rdt', desc = 'debug test' },
          go_to_file = { lhs = 'g', desc = 'go to file' },
          run_all = { lhs = '<leader>Rta', desc = 'run all tests' },
          run = { lhs = '<leader>Rtt', desc = 'run test' },
